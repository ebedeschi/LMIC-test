...
CPP_SRCS += \
C:\Program\ Files\sloeber\arduinoPlugin\libraries\arduino-lmic\2.3.2\src\aes\ideetron\AES-128_V10.cpp 

LINK_OBJ += \
.\libraries\arduino-lmic\src\aes\ideetron\AES-128_V10.cpp.o 

CPP_DEPS += \
.\libraries\arduino-lmic\src\aes\ideetron\AES-128_V10.cpp.d 


# Each subdirectory must supply rules for building sources it contributes
libraries\arduino-lmic\src\aes\ideetron\AES-128_V10.cpp.o: C:\Program\ Files\sloeber\arduinoPlugin\libraries\arduino-lmic\2.3.2\src\aes\ideetron\AES-128_V10.cpp
	@echo 'Building file: $<'
